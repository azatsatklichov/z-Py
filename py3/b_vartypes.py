...
a, b, c, d = 10, 0xDEFABCECBDAECBFBAE, 0.0, 3e+26J  # 0xDEFABCECBDAECBFBAEl
print(a, b, c, d)
...
_list[0] = 'ABcd'  # updating list (in tuple can not be possible)
...
print(_list[1:17])  # GOOD no Index out of bound exception
...
# TUPLE can not be updated - READ only list
_tuple = ('abcd', 786 , 2.23, 'john', 70.2)
# list can be updatabale
_list = [ 'abcd', 786 , 2.23, 'john', 70.2  ]
...
# print(_dict + tinydict) #TypeError: unsupported operand type(s) for +: 'dict' and 'dict'
